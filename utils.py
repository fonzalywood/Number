tvg_ids_logos = {'GOL MUNDIAL HD': 'https://i.postimg.cc/3ryZ9n8G/golmundial.png',
                 ...
                 #NBA
                 'I216.32281.zap2it.com': 'https://i.imgur.com/4QrPlos.png',
                 #TENNIS CHANNEL
                 'I217.33395.zap2it.com': 'https://telegra.ph/file/8807aa3ba9ca7f2232492.jpg',
                 #SKY SPORTS MAIN EVENT
                 'I401.1229.tvguide.co.uk': 'https://telegra.ph/file/f435538aa2919bbdf802c.jpg',
                 ...
                 'OTROS': 'https://telegra.ph/file/d4d9a410917c5c13f9c5a.png'}
                 #'OTROS': 'https://i.imgur.com/U4w7Bgy.png'}


group_title_order = ["EVENTOS", "DAZN F1", "GOL MUNDIAL", "GOL MUNDIAL 2", "M+ LaLiga", "DAZN LaLiga", "M+ Champions", "MIS CANALES", "DAZN", "M+ Deportes", "M+ LaLiga BAR", "M+ LaLiga Hypermotion", "EuroSport", "Otros deportes", "electroperra", "Otros"]
...
def extract_group_title(channel_title):
    ...
    if "F1" in title and "BY ÁLEX" in title:
        return "DAZN F1"
        ...
        #else:
            #return "GOL MUNDIAL"
    elif "GOL" in title or "TDP" in title or "TENNIS" in title or "SPORT" in title or "BARÇA" in title or "ESPN" in title or "SETENTA" in title or "EUROSPORT" in title or "NBA" in title:
        return "Otros deportes"
    else:
        return "Otros"
...
def extract_tvg_id(channel_title):
    ...
    if "F1" in title and "BY ÁLEX" in title:
        ...
        return "OTROS"
    elif "BARÇA" in title or "BARCA" in title or "BARÃ§A" in title:
        return "Barcelona TV"
        ...
        return "La 1 HD"
    elif "LALIGA TV BAR" in title: #and "BARÇA" not in title and "BARCELONA" not in title:
        ...
        return "I216.32281.zap2it.com"
    elif "SKY SPORTS MAIN EVENT" in title:
        return "I401.1229.tvguide.co.uk"
    else:
        return "OTROS"
